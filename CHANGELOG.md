...
- **Update toast layout fixed on narrow screens.** The message used to wrap one word per line next to the buttons; it now flexes properly within a sensible width.
